...
<acounts-layout>
    <div class="lg:w-3/4 mt-12 lg:mt-0">
        <div class="bg-grey-light py-8 px-5 md:px-8">
            <h1 class="font-hkbold text-secondary text-2xl pb-6 text-center sm:text-left">
                My Wishlist</h1>
            <div class="hidden sm:block">
                <div class="flex justify-between pb-3">
                    ...
                    <div class="w-3/10 md:w-1/5 text-center">
                        <p class="font-hkbold text-secondary text-sm uppercase pr-8 md:pr-16 xl:pr-8">
                            Action</p>
                    </div>
                </div>
            </div>
            ...
            <div
                    ...
                    <div class="w-20 mx-auto sm:mx-0 relative sm:mr-3 sm:pr-0">
                        <div class="h-20 rounded flex items-center justify-center">
                            <div class="w-12 h-16 mx-auto bg-center bg-no-repeat bg-cover"
                                style="background-image:url(/assets/img/unlicensed/shoes-3.png)">
                            </div>
                        </div>
                    </div>
                ...
                <div
                    class="w-full sm:w-1/6 md:w-1/6 xl:w-1/5 text-center border-b sm:border-b-0 border-grey-dark pb-4 sm:pb-0">
                    <span
                ...
                <a href="/" class="btn btn-primary whitespace-no-wrap">
                    Order Now
                </a>
            </div>
            ...
            <div class="pt-6 flex justify-center md:justify-end">
                ...
                <span class="font-hksemibold text-black transition-colors hover:text-white text-sm hover:bg-primary h-6 w-6 rounded-full flex items-centerjustify-center mr-3 cursor-pointer">2</span>
