        ...
        <div class="bg-grey-light py-8 px-5 md:px-8">
            ...
            <div class="hidden sm:block">
                <div class="flex justify-between pb-3">
                    ...
                    <div class="w-3/10 md:w-1/5 text-center">
                        <p class="font-hkbold text-secondary text-sm uppercase pr-8 md:pr-16 xl:pr-8">Status</p>
                    </div>
                </div>
            </div>
            ...
            <div
                ...
                <div class="w-full sm:w-1/5 text-center border-b sm:border-b-0 border-grey-dark pb-4 sm:pb-0">
                    ...
                    <span class="font-hkregular text-secondary">{{OrderItem.Quantity}}</span>
                </div>
                <div class="w-full sm:w-1/5 text-center border-b sm:border-b-0 border-grey-dark pb-4 sm:pb-0">
                    <span class="font-hkbold text-secondary text-sm uppercase text-center pt-3 pb-2 block sm:hidden">#Order</span>
                    <span class="font-hkregular text-secondary text-v-blue ">{{OrderItem.OrderNumber}}</span>
                </div>
                <div
                    ...
                    <span class="font-hkregular text-secondary font-semibold oldstyle-nums ">{{OrderItem.Price}}</span>
                </div>
                <div class="w-full sm:w-3/10 md:w-1/4 xl:w-1/5 text-center sm:text-right ">
                    <div class="pt-3 sm:pt-0">
                        ...
                        <span :class="Stutus(OrderItem.OrderStatus)" class="px-4 py-3 inline-block rounded font-hkregular border ">
