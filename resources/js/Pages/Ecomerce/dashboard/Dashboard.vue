      ...
      <div class="bg-grey-light py-8 px-5 md:px-8">
        ...
        >
            ...
            <div class="w-20 mx-auto sm:mx-0 relative sm:mr-3 sm:pr-0">
              <div class="h-20 rounded flex items-center justify-center">
                <div
                  ...
                  :style="'background-image:url(' + Image(HistoryItem) + ')'"
                ></div>
              </div>
            </div>
            <span
          ...
          >
            ...
            >
            <span class="font-hkregular text-secondary"
              >${{ HistoryItem.Price }}</span
            >
          </div>
          <inertia-link
            :href="route('shop.show', HistoryItem.ProductSlug)"
            class="px-4 py-3 inline-block rounded font-hkregular bg-v-blue-light border border-v-blue text-v-blue hover:bg-blue-400 hover:text-white hover:border-white"
          >
            <span>Buy Again</span>
          </inertia-link>
        </div>
            ...
            <div
                ...
                <div
                    ...
                    <div class="w-20 mx-auto sm:mx-0 relative sm:mr-3 sm:pr-0">
                        <div class="h-20 rounded flex items-center justify-center">
                            <div class="w-12 h-16 mx-auto bg-center bg-no-repeat bg-cover"
                                style="background-image:url(./img/watch-4.png)">
                            </div>
                        </div>
                    </div>
