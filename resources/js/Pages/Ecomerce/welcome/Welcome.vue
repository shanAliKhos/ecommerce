  ...
  <div>
    ...
    <div class="pb-20 md:pb-32">
      <div class="text-center pb-12 md:pb-5">
        <h2
          class="font-regular text-gray-600 text-3xl md:text-4xl lg:text-7xl uppercase"
        >
          On sale
        </h2>
        <p class="font-regular text-gray-500 text-lg md:text-xl">
    ...
    <div class="pb-20 md:pb-24 lg:pb-32">
      ...
      >
        <div class="text-center sm:text-left">
          <h2
            class="font-regular text-gray-500 text-3xl md:text-4xl lg:text-7xl"
          >
            Store trends
          </h2>
          <p class="font-regular text-gray-400 text-lg md:text-xl pt-2">
        ...
        >
          Show more
          <i
            class="bx bx-chevron-right text-orange-500 transition-colors group-hover:text-orange-400 pl-3 pt-2 text-xl"
          ></i>
        </inertia-link>
      </div>
