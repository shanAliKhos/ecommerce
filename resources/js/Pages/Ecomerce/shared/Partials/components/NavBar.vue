            ...
            <div class="hidden lg:block h-10">
                <div class="flex items-center">
                    ...
                    <a href="javascript:;" class="border-2 transition-all border-transparent hover:border-primary rounded-full px-4 py-4 mr-8">
                        <span :class="IsAtTop" class="w-8 h-8 transition duration-500 ease-in-out bg-contain bg-center bg-no-repeat block  bg-icon-search hover:bg-icon-search-hover"></span>
                    </a>

                    <a href="javascript:;"
                        class="border-2 transition-all border-transparent hover:border-primary rounded-full px-4 py-4 group">
                        <span :class="IsAtTop" class="w-8 h-8 transition duration-500 ease-in-out  bg-contain bg-center bg-no-repeat  bg-icon-heart  block hover:bg-icon-heart-hover"></span>
                    </a>

                </div>
            </div>
            <button @click="back" type="button" class="lg:hidden">
                <svg  class="text-gray-400 hover:text-gray-500 text-xs w-8 h-8" :class="IsAtTop" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="hidden lg:block h-10">
                <div class="flex items-center">
                    ...
                    <inertia-link v-if="!$page.user"  :href="route('login')" class="border-2 transition-all border-transparent hover:border-primary rounded-full px-4 py-4 group relative">
                        ...
                        <span :class="IsAtTop" class="w-8 h-8 transition duration-500 ease-in-out bg-contain bg-center bg-no-repeat  block bg-icon-user  hover:bg-icon-user-hover"></span>
                    </inertia-link>
            ...
            <div class="block lg:hidden h-10">
                <div class="ml-3 relative">
                    <dropdown align="right" width="48">
                        <template #trigger> 
                            <svg :class="IsAtTop" class="w-8 h-8 text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
