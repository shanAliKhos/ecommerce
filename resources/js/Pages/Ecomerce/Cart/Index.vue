            ...
            <div class="lg:w-3/5">
                ...
                <div class="hidden lg:block">
                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center pt-8 sm:pt-12">
                        ...
                        <button v-if="CartItems?CartItems.length:false" @click="EmptyCart" type="button" class="flex items-center mt-2 justify-center uppercase transition duration-700 ease-in-out bg-orange-400 hover:bg-orange-500 focus:outline-none rounded-lg px-6 py-2 text-white font-semibold shadow items-center  w-full lg:w-1/3 lg:ml-2"> 
