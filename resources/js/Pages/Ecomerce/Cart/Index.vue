    ...
    <div class="container border-t   pt-10 sm:pt-12 mb-20 lg:mb-0">
        ...
        <div class="flex flex-col lg:flex-row justify-between pb-16 sm:pb-20 lg:pb-24">
            <div class="lg:w-3/5">
                 ...
                 <div class="mobile-secondary-menu z-50 bg-white block lg:hidden fixed bottom-12 right-0 left-0  border-t-2 border-gray-200 text-gray-500 ">
            ...
            <div class="sm:w-2/3 md:w-full lg:w-1/3 mx-auto lg:mx-0 mt-16 lg:mt-0">
                <div class="flex items-center justify-end px-4 py-3  text-right sm:px-6 hidden lg:block"> 
                  
                    <div class="flex item-center justify-around mt-2 text-sm mb-2 text-xs">
                    
                        <inertia-link :href="route('shop.index')" 
                        ...
                        <button v-if="CartItems?CartItems.length:false" @click="EmptyCart" type="button" class="flex items-center justify-center uppercase transition duration-700 ease-in-out bg-red-500 hover:bg-red-600 focus:outline-none rounded px-2 text-white font-semibold shadow items-center w-1/3 hover:shadow-2xl"> 
                    ...
                    <div class="py-2 px-2">
                        ...
                        <div class="border-b border-grey-darker pb-1 flex justify-between">
                            ...
                            <span class="font-semibold ">{{Currency}}{{CartTotalPrice}}</span>
                        </div>
                    ...
                    <div v-if="CartItems?CartItems.length:false">
                        <div class="flex justify-between py-2">
                            ...
                            <input type="text" placeholder="Discount code" class="w-3/5 xl:w-2/3 form-input rounded-sm mr-2" id="discount_code" />
                            <button class="flex items-center justify-center uppercase transition duration-700 ease-in-out bg-yellow-400 hover:bg-yellow-600 focus:outline-none rounded px-2  text-white font-semibold shadow items-center w-1/3  hover:shadow-2xl" aria-label="Apply button">Apply</button>
                        </div>                    
                        ...
                        <button  @click="ProceedToCheckOut" type="button"
                            ...
                            PROCEED 
                            <svg v-if="sending"  class="transition duration-700 ease-in-out  h-5 w-auto ml-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M4 2a1 1 0 011 1v2.101a7.002 7.002 0 0111.601 2.566 1 1 0 11-1.885.666A5.002 5.002 0 005.999 7H9a1 1 0 010 2H4a1 1 0 01-1-1V3a1 1 0 011-1zm.008 9.057a1 1 0 011.276.61A5.002 5.002 0 0014.001 13H11a1 1 0 110-2h5a1 1 0 011 1v5a1 1 0 11-2 0v-2.101a7.002 7.002 0 01-11.601-2.566 1 1 0 01.61-1.276z" clip-rule="evenodd" />
                            </svg>                              
                            <svg v-else class="transition duration-700 ease-in-out  h-5 w-auto ml-1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3" />
                            </svg>           
                        </button>   
                    </div> 
                ...
                <div class="bg-grey-light py-8 px-8"> 
                    <div> 
                        <p class="font-semibold  text-sm pb-4">Cart Note Special instructions for us</p>
