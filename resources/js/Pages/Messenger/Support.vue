...
<div class="fixed bottom-0 right-0 flex flex-col items-end z-30 w-auto">
    <div class="chat-modal mr-5 flex flex-col mb-5 shadow-lg  w-full  z-0">
      ...
      <!-- admin profile -->
      <div class=" z-30 flex justify-between items-center text-white p-2 bg-green-500 border shadow-lg mr-5 w-full">
      ...
      <!-- chats -->
      <div class=" z-30 flex flex-col bg-gray-200 px-2 chat-services overflow-auto">
      ...
      <div class=" z-30 relative bg-white">
        <input  v-model="message" @keydown.enter="send"  type="text" name="message" placeholder="ketik pesan anda" class="pl-4 pr-16 py-2 border border-green-500 focus:outline-none w-full">
        <button @click="send" class="absolute right-0 bottom-0 text-green-600 bg-white hover:text-green-500 m-1 px-3 py-1 w-auto transistion-color duration-100 focus:outline-none">Send</button>
      </div>
    </div>
    <div class=" z-30 show-chat mx-10 mb-6 mt-4 text-green-500 hover:text-green-600 flex justify-center items-center cursor-pointer ">
