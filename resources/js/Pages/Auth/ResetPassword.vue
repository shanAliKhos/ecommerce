    ...
    <div class="mt-10">
      <form @submit.prevent="submit">
        ...
        <div class="flex w-full">
          <button type="submit" :disabled="sending" class="flex items-center justify-center focus:outline-none text-white text-sm sm:text-base bg-orange-400 hover:bg-red-700 rounded py-2 w-full transition duration-150 ease-in">
