 ...
 <div> 
    ...
    <div class="py-5 px-5 bg-white rounded shadow-2xl">
        ...
        <table class="border-collapse w-full table-auto">
            ...
            <tbody>
                <list-item v-for="(Order, OrderIndex) in Orders" :key="OrderIndex" :OrderIndex="OrderIndex"  :Order="Order"></list-item>
                <tr v-if="(!Orders.length > 0)" class="bg-white lg:hover:bg-gray-100 flex lg:table-row flex-row lg:flex-row flex-wrap lg:flex-no-wrap mb-10 lg:mb-0">
