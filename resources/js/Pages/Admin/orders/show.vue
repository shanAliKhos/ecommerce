                ...
                <div class="tile-footer">
                    <div class="row d-print-none mt-2">
                        <div class="col-12 text-right">
                            <!-- <inertia-link v-if="(Order.Status == 'pending')"  -->
                            <inertia-link  
                                v-if="Order.Status !== 'pending'"
                                as="button" type="button" class="btn btn-warning"
                                :data="{ Status: 'pending' }"  
                            ...
                            <inertia-link  
                                ...
                                as="button" type="button" class="btn btn-info"
                            ...
                            <!-- <inertia-link v-if="(Order.Status == 'processing')"  -->
                            <inertia-link  
                                v-if="Order.Status !== 'completed'"
                                as="button" type="button" class="btn btn-success"
                                method="put" preserve-scroll 
