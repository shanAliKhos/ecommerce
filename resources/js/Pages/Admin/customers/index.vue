...
<div>
    <nav class="text-sm font-semibold mb-6" aria-label="Breadcrumb">
        <ol class="list-none p-0 inline-flex text-blue-400">
            <li class="flex items-center"> 
                <inertia-link :href="route('admin.dashboard')">Home</inertia-link>        
    ...
    <div class="my-8 p-10 bg-white rounded shadow-2xl">
        <p class="pb-6 flex font-semibold text-xl text-gray-400">Customer Listing</p>    
        <table class="border-collapse w-full table-auto ">
            <thead>
                <tr>
                    ...
                    <th class="p-3 font-bold uppercase bg-gray-200 text-gray-600 border border-gray-300 hidden lg:table-cell">Email Verified</th> 
                    <th class="p-3 font-bold uppercase bg-gray-200 text-gray-600 border border-gray-300 hidden lg:table-cell">ACTIONS</th>
                </tr>
            </thead>
            <tbody>
                <list-item v-for="(Customer, CustomerIndex) in Customers" :key="CustomerIndex" :CustomerIndex="CustomerIndex" :Customer="Customer"></list-item> 
                <tr v-if="(!Customers.length > 0)" class="bg-white lg:hover:bg-gray-100 flex lg:table-row flex-row lg:flex-row flex-wrap lg:flex-no-wrap mb-10 lg:mb-0">
