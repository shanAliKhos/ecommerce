<template>
    <div class="xx-sidebar h-full ">
        ...
        <div class="w-4/5 md:w-1/3 lg:w-64 fixed md:top-0 md:left-0 h-full lg:block bg-gray-100 border-r border-gray-300 z-30 pb-5 overflow-y-auto overflow-x-hidden h-full px-5" :class="sideBarOpen ? '' : 'hidden'" id="main-nav">
            ...
            <div class="">
                ...
                <div class="mb-4 mt-4 ">
                    ...
                    <side-link 
                        ...
                        <svg class="h-6 w-6 mr-2" viewBox="0 0 20 20">
                ...
                <div class="mb-4 mt-4 ">
                    ...
                    <side-link 
                        ...
                        :active="$page.currentRouteName == 'admin.slider.hero.index'">
                        <svg class="h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <side-link 
                        :href="route('admin.slider.sale.index')" 
                        :active="$page.currentRouteName == 'admin.slider.sale.index'">
                            <svg class="h-6 w-6  mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                            </svg>
                    ...
                    <side-link 
                        :href="route('admin.slider.trending.index')" 
                        :active="$page.currentRouteName == 'admin.slider.trending.index'">
                        <svg class="h-6 w-6  mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                        </svg>
