<template>
    <div class="w-1/2 md:w-1/3 lg:w-64 fixed md:top-0 md:left-0 h-screen lg:block bg-gray-100 border-r  border-gray-300 z-30" :class="sideBarOpen ? '' : 'hidden'" id="main-nav">
