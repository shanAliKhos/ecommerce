              ...
              <div class="flex">
                ...
                <div class="relative text-gray-600">
                  <input type="search" 
                    ...
                    <button type="submit" class="absolute right-0 top-0 mt-3 mr-4 transition duration-500 ease-in-out text-gray-300 hover:text-blue-400 focus:outline-none focus:text-blue-500">
