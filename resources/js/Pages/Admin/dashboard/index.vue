...
<div class="adminstation-dashboard">
  ...
  <div class="lg:flex justify-between items-center mb-6">
    <p class="text-2xl font-semibold mb-2 lg:mb-0 text-gray-500">Hello , {{AuthenicatedUserName}}!</p>
  ...
  <div class="flex flex-wrap -mx-3">
      ...
      <div class="w-full xl:w-1/3 px-3">
        <p class="text-xl font-semibold mb-4 text-gray-500">Recent Sales</p>
      ...
      <div class="w-full xl:w-1/3 px-3">
        <p class="text-xl font-semibold mb-4 text-gray-500">Recent Reviews</p>
      ...
      <div class="w-full xl:w-1/3 px-3">
        <p class="text-xl font-semibold mb-4 text-gray-500">Recent Transactions</p>
