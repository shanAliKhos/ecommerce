 ...
 <div> 
    ...
    <div class="my-8 p-10 bg-white rounded shadow-2xl">
        ...
        <table class="border-collapse w-full table-auto ">
            <thead>
                <tr>
                    <th class="p-3 font-bold uppercase bg-gray-200 text-gray-600   hidden lg:table-cell">#</th>
                    <th class="p-3 font-bold uppercase bg-gray-200 text-gray-600   hidden lg:table-cell">IMAGE</th>
                    <th class="p-3 font-bold uppercase bg-gray-200 text-gray-600   hidden lg:table-cell">NAME</th>
                    <th class="p-3 font-bold uppercase bg-gray-200 text-gray-600   hidden lg:table-cell">SKU</th>
                    ...
                    <th class="p-3 font-bold uppercase bg-gray-200 text-gray-600   hidden lg:table-cell">Price</th>
                    <th class="p-3 font-bold uppercase bg-gray-200 text-gray-600   hidden lg:table-cell">Status</th>
                    <th class="p-3 font-bold uppercase bg-gray-200 text-gray-600   hidden lg:table-cell">ACTIONS</th>
                </tr>
            </thead>
            <tbody> 
