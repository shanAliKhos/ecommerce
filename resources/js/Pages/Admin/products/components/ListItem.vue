<template>
<tr class="group transition duration-500 ease-in-out transform rounded-lg text-xs text-gray-500  lg:hover:bg-white hover:shadow-lg flex lg:table-row flex-row lg:flex-row flex-wrap lg:flex-no-wrap mb-10 hover:shadow-2xl hover:bg-white  ">
    ...
    <td class="border-l border-b border-gray-300 w-1/2 lg:w-auto p-3     block lg:table-cell relative lg:static">
        ...
        <div class="inline-flex py-5  lg:p-1">
            ...
            <inertia-link :href="route('admin.product.edit',Product.id)" class="transition duration-500 ease-in-out bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-1 px-1 border-blue-500 hover:border-transparent rounded inline-flex items-center mr-2">
            ...
            <inertia-link :href="route('shop.show',Product.slug)" class="transition duration-500 ease-in-out bg-transparent hover:bg-green-500 text-green-700 font-semibold hover:text-white py-1 px-1 border-blue-500 hover:border-transparent rounded inline-flex justify-center items-center">
                <svg class="w-auto h-8" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
