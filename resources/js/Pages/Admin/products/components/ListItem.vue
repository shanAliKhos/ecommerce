<template>
<tr class="text-xs text-gray-500 bg-white lg:hover:bg-gray-100 flex lg:table-row flex-row lg:flex-row flex-wrap lg:flex-no-wrap mb-10 lg:mb-0">
    <td class="w-full lg:w-auto p-3  text-center border-b-gray-300 block lg:table-cell relative lg:static">
    ...
    <td class="w-full lg:w-auto p-3  text-center border-b-gray-300 block lg:table-cell relative lg:static">
        ...
        <div class="flex items-center py-5  lg:p-1">
            <div class="flex-shrink-0 h-full w-auto">
                <img class="h-full w-auto sm:w-44 sm:h-44 lg:w-20 lg:h-20 rounded" :src="Product.mainphoto_url" alt="">
            </div> 
        </div>             
    </td>
    <td class="w-full lg:w-auto p-3  text-center border-b-gray-300 text-center block lg:table-cell relative lg:static">
