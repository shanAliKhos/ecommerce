    ...
    <div class="w-full pl-0 md:pl-2">
      <div class="leading-loose">
        <form @submit.prevent="store">
          <p class="pb-6 flex font-semibold text-xl text-gray-400">
            Product Create
          </p>
              ...
              <div class="flex flex-wrap item-center md:justify-end">
                <div class="w-1/2">
                  ...
                  >
                    <div
                      :class="{
                        'text-green-400': form.is_active,
                        'text-red-500': !form.is_active,
                      }"
                    ...
                    <div class="relative">
                      ...
                      />
                      <div
                        class="toggle-path bg-red-400 w-9 h-5 rounded-full shadow-inner"
                      ></div>
                      <div
                  ...
                  <p
                    ...
                    v-if="$page.errors.is_active"
                  >
                    {{ $page.errors.is_active }}
                  </p>
                </div>
                ...
                <div class="w-1/2">
                  ...
                  >
                    <div
                      :class="{
                        'text-green-400': form.is_featured,
                        'text-red-500': !form.is_featured,
                      }"
                      class="px-2 font-semibold"
                    >
                      Featured
                  ...
                  <p
                    class="text-red-500 text-xs italic"
                    v-if="$page.errors.is_featured"
                  >
                    {{ $page.errors.is_featured }}
                  </p>
                </div>
              </div>
            ...
            <div class="w-full md:w-2/3 px-2 md:mb-0">
              ...
              <div class="flex py-2">
                ...
                >
                  <div
                    :class="{
                      'text-green-400': form.is_variable,
                      'text-red-500': !form.is_variable,
                    }"
                    class="px-2 font-semibold"
                  >
                    Variations
                ...
                <p
                  class="text-red-500 text-xs italic"
                  v-if="$page.errors.is_variable"
                >
                  {{ $page.errors.is_variable }}
                </p>
              </div>
              ...
              <transition-group name="slide-fade">
                ...
                >
                  <label
                    class="z-20 absolute top-0 right-3 text-purple-600 px-1 py-0 text-xs font-bold uppercase"
                    for="weight"
                  ...
                  <p
                    class="z-20 absolute bottom-0 right-3 text-red-500 text-xs italic"
                    v-if="$page.errors.attributes"
                  >
                    {{ $page.errors.attributes }}
                  </p>
                </div>
                ...
                >
                  <transition-group name="slide-fade">
                    <div
                      class="w-full md:mb-0 relative mt-2"
              ...
              <div class="w-full md:mb-0 relative mt-2">
                ...
                <p
                  class="z-20 absolute bottom-0 right-3 text-red-500 text-xs italic"
                  v-if="$page.errors.categories"
                >
                  {{ $page.errors.categories }}
                </p>
              </div>

              <div class="mt-5 mb-5 relative">
                <label
                  class="absolute top-0 right-3 text-purple-600 px-1 py-0 text-xs font-bold uppercase"
                  for="weight"
                  >Description</label
                >
                <vue-editor
                  ...
                  class="transition duration-700 ease-in-out w-full bg-gray-50 rounded-lg shadow-sm hover:bg-white hover:shadow-2xl focus:bg-white focus:shadow-2xl focus:outline-none focus:border-purple-600 border-2 border-gray-200 z-20"
                ></vue-editor>
                <p
                  class="z-20 absolute bottom-0 right-3 text-red-500 text-xs italic"
          ...
          <div
            ...
            v-if="form.is_variable && ProductSkus.length > 0"
          >
            <p class="pb-6 flex font-semibold text-xl text-gray-400">
            ...
            <div class="flex flex-wrap">
              <div
                class="w-full md:w-1/2 bg-white mb-4 rounded shadow"
                v-for="(ProductSku, ProductSkuIndex) in ProductSkus"
                :key="ProductSkuIndex"
              >
                <div
                  class="px-2 py-2 rounded-lg bg-gray-50 text-blue-800 font-semibold"
                >
                  {{ ProductSku.sku }}
                </div>
                ...
                <div class="flex flex-wrap mb-2 px-2 py-2">
                  <div class="w-1/2 md:w-1/3">
                    <p
                      class="text-gray-600"
                      v-for="(
                        skus_option, skus_option_index
                      ) in ProductSku.skus_options"
                      :key="skus_option_index"
                    >
                      <span class="font-semibold"
                        >{{
                          skus_option.variant_option.attributes_option.attribute
                            .name
                        }}
                        -</span
                      >
                      {{ skus_option.variant_option.attributes_option.name }}
                    </p>
                  </div>

                  <div
                    class="w-1/2 md:w-2/3 md:flex md:flex-wrap px-2 md:mb-0 relative"
                  >
                    <text-input
                      type="number"
                      class="w-full px-2"
                      ...
                      :error="
                        $page.errors.ProductSku ? ProductSku.quantity : ''
                      "
                      label="#SKU Quantity"
                      :labelRequire="true"
                    ...
                    <text-input
                      ...
                      autocomplete="regular_price"
                      :error="
                        $page.errors.ProductSku ? ProductSku.regular_price : ''
                      "
                      label="$ regular_price"
                      :labelRequire="true"
                    ...
                    <text-input
                      ...
                      autocomplete="sale_price"
                      :error="
                        $page.errors.ProductSku ? ProductSku.sale_price : ''
                      "
                      label="$ sale_price"
                      :labelRequire="true"
          ...
          <div class="md:flex-none flex fixed bottom-0 right-0 z-50">
            <div class="flex items-center md:justify-end px-2 py-2">
              <loading-button
                :loading="sending"
                class="uppercase w-full flex items-center justify-center transition duration-700 ease-in-out bg-green-400 hover:bg-green-600 focus:outline-none rounded-lg px-2 py-1 text-white font-semibold shadow inline-flex"
                type="submit"
                as="button"
              >
                ...
                <svg
                  v-if="!sending"
                  class="transition duration-700 ease-in-out h-5 w-5 ml-2"
...
export default {
  ...
  data() {
    return {
      ...
      form: {
        ...
        regular_price: this.$page.Product
          ? this.$page.Product.regular_price
          : null,
        ...
        is_featured: this.$page.Product
          ? this.$page.Product.is_featured
          : false,
        image: this.$page.Product ? this.$page.Product.mainphoto_url : null,
        is_variable: this.$page.Product
          ? this.$page.Product.variations.length > 0
            ? true
            : false
          : false,
  ...
  methods: {
    store() {
      ...
      self.$inertia.post(
        self.$page.Product
          ? route("admin.product.update", self.$page.Product.id)
