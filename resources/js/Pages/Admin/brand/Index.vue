...
<div>
    <nav class="text-sm font-semibold mb-6" aria-label="Breadcrumb">
        ...
        <inertia-link 
            ...
            class="transition duration-700 ease-in-out bg-blue-300 hover:bg-blue-600 hover:text-white text-gray-800 font-bold py-2 px-4 rounded inline-flex items-center float-right"
            >  
                ...
                <tr v-for="(Brand, index) in Brands" :key="index" class="bg-white lg:hover:bg-gray-100 flex lg:table-row flex-row lg:flex-row flex-wrap lg:flex-no-wrap mb-10 lg:mb-0">
                    ...
                    <td class="w-full lg:w-auto p-3 text-gray-800 text-center border border-b text-center block lg:table-cell relative lg:static">
                        ...
                        <div class="inline-flex py-5  lg:p-1 ">
                            ...
                            <inertia-link :href="route('admin.brand.edit', Brand.id)" class="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-1 px-1 border border-blue-500 hover:border-transparent rounded inline-flex items-center mr-3">                                        
