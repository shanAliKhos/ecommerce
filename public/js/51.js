...
var render = function() {
  ...
  return _c("div", { staticClass: "container mx-auto relative" }, [
    _c(
      ...
      [
        ...
        _c(
          "inertia-link",
          {
            staticClass: "flex items-center flex-inline justify-center",
            ...
            [
              ...
              !_vm.$page.user
                ? _c(
                    ...
                    {
                      staticClass:
                        "border-2 transition-all border-transparent hover:border-orange-500 rounded-full px-4 py-4 group relative",
                      attrs: { href: _vm.route("login") }
                    },
                    [
                      _c(
                        "span",
                        { staticClass: "flex h-3 w-3 absolute right-2" },
                        [
                          _c("span", {
                            staticClass:
        ...
        _vm._v(" "),
        _c("div", { staticClass: "block md:hidden flex" }, [
          _c(
            "div",
    ...
    _c(
      ...
      {
        staticClass:
          "flex items-center justify-around font-semibold hidden md:block"
      },
      [
        _c(
          "ul",
