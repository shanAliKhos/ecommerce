...
var render = function() {
  ...
  return _c("div", { staticClass: "font-semibold  text-gray-800" }, [
    _c(
      "nav",
      { staticClass: "text-sm  mb-6", attrs: { "aria-label": "Breadcrumb" } },
      [
    ...
    _vm._v(" "),
    _c("div", { staticClass: "my-8 p-10  rounded shadow-xl" }, [
      _c("p", { staticClass: "pb-6 flex  text-xl font-bold" }, [
        _vm._v("Order#  "),
      ...
      _c("div", { staticClass: "flex flex-wrap -mx-3 mb-5 " }, [
        _c("div", { staticClass: "w-full md:w-1/3 px-3 md:mb-0" }, [
          _c(
            ...
            {
              staticClass:
                "transition ease-in-out duration-700 transform transform-gpu  shadow h-60 hover:bg-white hover:shadow-2xl hover:scale-105 border border-gray-200 px-5 py-5 mr-2"
            },
            [
              _c(
                "p",
                { staticClass: "pb-6 flex  text-lg text-blue-700 uppercase" },
                [_vm._v("Placed by")]
              ),
              _vm._v(" "),
              _c("p", { staticClass: "flex  text-sm  uppercase" }, [
        ...
        _c(
          ...
          [
            _c(
              ...
              {
                staticClass:
                  "transition ease-in-out duration-700 transform transform-gpu  shadow h-60 hover:bg-white hover:shadow-2xl hover:scale-105 border border-gray-200 px-5 py-5 mr-2 shadow h-60"
              },
              [
                _c(
                  "p",
          ...
          [
            _c(
              ...
              [
                ...
                _vm._v(" "),
                _c("p", { staticClass: " text-sm  uppercase" }, [
                  _vm._v("Status : "),
      ...
      _c("div", { staticClass: "flex flex-wrap mx-3 mb-10 mt-10" }, [
        _c(
          ...
          {
            staticClass:
              "text-xl font-bold text-blue-700 flex text-center justify-center w-full mb-5"
          },
          [_vm._v(" Items ")]
        ),
        _vm._v(" "),
        _c(
          ...
          [
            ...
            _c(
              "tbody",
              _vm._l(_vm.Order.items, function(OrderItem, OrderItemIndex) {
                return _c(
                  "tr",
                  {
                    key: OrderItemIndex,
                    staticClass:
                      "transition ease-in-out duration-700 transform transform-gpu  hover:bg-white hover:shadow-2xl flex lg:table-row flex-row lg:flex-row flex-wrap lg:flex-no-wrap mb-10 lg:mb-0 font-semibold"
                  },
                  [
                    _c(
                      "td",
                      ...
                      [
                        ...
                        _c("p", { staticClass: "py-5  lg:p-1 " }, [
                          _vm._v(_vm._s(OrderItemIndex + 1))
                        ])
                      ]
                    ),
                    _vm._v(" "),
                    _c(
                      ...
                      [
                        ...
                        _c(
                          "div",
                          { staticClass: "py-5 lg:p-1 text-sm" },
                          _vm._l(JSON.parse(OrderItem.variation), function(
                            variation,
                            variationIndex
                          ) {
                            return _c("span", { key: variationIndex }, [
                              _vm._v(
                                " " +
                                  _vm._s(variationIndex) +
                                  " : " +
                                  _vm._s(variation) +
                                  " "
                              )
                    ...
                    _c(
                      ...
                      [
                        ...
                        _vm._v(" "),
                        _c("p", { staticClass: "py-5  lg:p-1 " }, [
                          _vm._v(_vm._s(OrderItem.product.sku))
                        ])
                      ]
                    ),
                    _vm._v(" "),
...
var staticRenderFns = [
  function() {
    ...
    return _c("li", { staticClass: "flex items-center" }, [
      _c("a", { attrs: { href: "#" } }, [_vm._v("Order Show")])
    ])
  },
  function() {
    var _vm = this
    ...
    return _c("thead", [
      _c("tr", { staticClass: "bg-gray-100" }, [
        _c(
          ...
          {
            staticClass:
              "p-3  uppercase text-gray-600 border border-gray-300 hidden  lg:table-cell"
          },
          [_vm._v("#")]
        ),
        _vm._v(" "),
