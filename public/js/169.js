...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    IsActiveLink: function IsActiveLink() {
      return this.active ? 'focus:-translate-x-1 block font-semibold  text-orange-300  border-b-4 border-orange-300 px-2' : 'hover:-translate-x-1 block font-semibold text-blue-400  hover:text-orange-300  border-b-4  h-10 pl-4    hover:shadow hover:border-orange-300 px-2 rounded-lg cursor-pointer';
    }
  }
});
...
var render = function() {
  ...
  return _c(
    ...
    {
      staticClass:
        "transition duration-500 ease-in-out w-full flex items-center ",
