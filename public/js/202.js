...
var render = function() {
  ...
  return _c("div", { staticClass: "p-1" }, [
    _c(
      ...
      {
        staticClass:
          "product-gird transition duration-700 ease-in-out shadow-sm hover:shadow-2xl rounded-lg pb-2"
      },
      [
        _c(
          "inertia-link",
          ...
          [
            ...
            _c(
              "div",
              { staticClass: "flex justify-center items-center w-auto h-64" },
              [
                _c("img", {
                  staticClass:
                    "w-auto h-56 bg-center bg-no-repeat bg-cover transition transform duration-500 ease-in-out hover:shadow-lg rounded-lg",
