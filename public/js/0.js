...
var render = function() {
  ...
  return _c(
    ...
    {
      staticClass:
        "py-2 px-2 flex rounded lg:cursor-pointer block font-semibold transition duration-500 ease-in-out transform  items-center hover:shadow",
...
var render = function() {
  ...
  return _c("div", { staticClass: "xx-sidebar h-full " }, [
    ...
    _c(
      ...
      {
        staticClass:
          "w-4/5 md:w-1/3 lg:w-64 fixed md:top-0 md:left-0 h-full lg:block bg-gray-100 border-r border-gray-300 z-30 pb-5 overflow-y-auto overflow-x-hidden h-full px-5",
              ...
              _c(
                "side-link",
                {
                  attrs: {
                    ...
                    active: _vm.$page.currentRouteName == "admin.category.index"
                  }
                },
                [
                  _c(
              ...
              _c(
                "side-link",
                {
                  attrs: {
                    ...
                    active: _vm.$page.currentRouteName == "admin.customer.index"
                  }
                },
                [
                  _c(
              ...
              _c(
                "side-link",
                {
                  attrs: {
                    ...
                    active: _vm.$page.currentRouteName == "admin.setting.index"
                  }
                },
                [
                  _c(
