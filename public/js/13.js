  ...
  methods: {
    destroy: function destroy() {
      ...
      self.$swal.fire({
        ...
        if (result.isConfirmed) {// self.$inertia.delete(self.route('admin.category.destroy', self.Category.id), {
          //     preserveState: true,
          //     preserveScroll: true,  
            ...
            [
              _c(
                "inertia-link",
                {
                  ...
                  attrs: {
                    href: _vm.route("admin.customer.edit", _vm.Customer.id)
                  }
                },
                [
                  _c(
              ...
              _c(
                ...
                {
                  staticClass:
                    " transition duration-500 ease-in-out bg-transparent hover:bg-yellow-300 text-yellow-400 font-semibold hover:text-white py-1 px-1 border border-yellow-500 hover:border-transparent rounded inline-flex items-center mr-3",
                  attrs: {
