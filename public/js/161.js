...
var render = function() {
  ...
  return _c(
    ...
    {
      staticClass:
        "z-50 bg-gray-50 px-2 py-2 block md:hidden fixed bottom-0 right-0 left-0 shadow-lg  border-t-2 border-gray-400"
    },
    [
      _c(
        "div",
        { staticClass: "grid grid-cols-4 gap-4 flex justify-around" },
        [
          _c(
            "inertia-link",
            {
            ...
            [
              _c(
                ...
                {
                  staticClass:
                    "justify-items-center transition duration-700 ease-in-out h-5 w-5 ",
                  attrs: {
              ...
              _vm._v(" "),
              _c("span", { staticClass: " ml-2" }, [_vm._v("Cart")])
            ]
          )
        ],
        1
