                      ...
                      _c("div", { staticClass: "col-md-3 col-sm-6" }, [
                        _c("div", { staticClass: "form-group" }, [
                          ...
                          _c("input", {
                            ...
                            domProps: { value: _vm.Product.regular_price },
                            on: {
                              input: function($event) {
                                if ($event.target.composing) {
                                  return
                      ...
                      _c("div", { staticClass: "form-check" }, [
                        _c("label", { staticClass: "form-check-label" }, [
                          _c("input", {
                            ...
                            domProps: {
                              checked: Array.isArray(_vm.Product.is_active)
                                ? _vm._i(_vm.Product.is_active, null) > -1
                                : _vm.Product.is_active
                            },
                            on: {
                              change: function($event) {
                                var $$a = _vm.Product.is_active,
                                  $$el = $event.target,
                                ...
                                if (Array.isArray($$a)) {
                                  ...
                                  _vm.$set(_vm.Product, "is_active", $$c)
                                }
                              }
                            }
                          }),
                          _vm._v(
                            "Status : " +
                              _vm._s(
                                _vm.Product.is_active ? "Active" : "Disabled"
                              ) +
                              "\n                                        "
                          )
                        ])
                      ...
                      _c("div", { staticClass: "form-check" }, [
                        _c("label", { staticClass: "form-check-label" }, [
                          _c("input", {
                            ...
                            domProps: {
                              checked: Array.isArray(_vm.Product.is_featured)
                                ? _vm._i(_vm.Product.is_featured, null) > -1
                                : _vm.Product.is_featured
                            },
                            on: {
                              change: function($event) {
                                var $$a = _vm.Product.is_featured,
                                  $$el = $event.target,
                                  $$c = $$el.checked ? true : false
                                if (Array.isArray($$a)) {
                                  var $$v = null,
                                  ...
                                  _vm.$set(_vm.Product, "is_featured", $$c)
                                }
                              }
                            }
                          }),
