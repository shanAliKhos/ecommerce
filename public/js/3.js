...
/* harmony import */ var _Shared_Logo__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../../../Shared/Logo */ "./resources/js/Pages/Shared/Logo.vue");
...
var render = function() {
  ...
  return _c(
    ...
    {
      staticClass:
        "w-1/2 md:w-1/3 lg:w-64 fixed md:top-0 md:left-0 h-screen lg:block bg-gray-100 border-r  border-gray-300 z-30",
        ...
        [
          ...
          _c(
            "inertia-link",
            {
              staticClass:
                "w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer",
              class: {
                "bg-gray-200": _vm.$page.currentRouteName == "admin.user.index"
              },
          ...
          _c(
            "inertia-link",
            {
              staticClass:
                "w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer",
              class: { "bg-gray-200": _vm.$page.currentRouteName == "welcome" },
            ...
            [
              ...
              _vm._v(" "),
              _c("span", { staticClass: "text-gray-700" }, [_vm._v("Website")])
            ]
          )
        ],
        1
