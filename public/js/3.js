...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ApplicationLogo: function ApplicationLogo() {
      return __webpack_require__.e(/*! import() */ 194).then(__webpack_require__.bind(null, /*! ./components/ApplicationLogo */ "./resources/js/Pages/Ecomerce/shared/Partials/components/ApplicationLogo.vue"));
    }
  },
  computed: {
...
var render = function() {
  ...
  return _vm.IsVisibleFooter
    ? _c("div", { staticClass: "xxstheme-footer bg-gray-200 " }, [
        _vm._m(0),
        _vm._v(" "),
        _c("div", { staticClass: "py-16 sm:py-20 md:py-24 text-gray-500" }, [
          _c(
            "div",
            {
              staticClass:
                "flex flex-col lg:flex-row items-center justify-around lg:px-20"
            },
            [
              _c("div", { staticClass: "lg:w-1/3 py-5 order-2 lg:order-1" }, [
                _c(
                  "p",
                  {
                    staticClass:
                      "font-semibold text-2xl pb-8 flex items-center justify-center lg:justify-start"
                  },
                  [_vm._v("Contact")]
                ),
                _vm._v(" "),
                _c("ul", [
                  _c(
                    ...
                    {
                      staticClass:
                        "pb-2 block flex items-center justify-center lg:justify-start"
                    },
                    [
                      _c(
                        "a",
              ...
              _c(
                "div",
                { staticClass: "lg:w-1/3 py-5 order-1 lg:order-2" },
                [
                  _c(
                    "inertia-link",
                    {
                      staticClass:
                        "font-semibold  text-4xl uppercase tracking-wider flex items-center justify-center",
                      attrs: { href: _vm.route("welcome") }
                    },
                    [
                      _vm._v(
              ...
              _vm._v(" "),
              _c("div", { staticClass: "w-1/3 py-5 order-3 lg:order-3" }, [
                _c(
                  "p",
                  {
                    staticClass:
                      "font-semibold text-2xl pb-8 flex items-center justify-center lg:justify-end"
                  },
                  [_vm._v("Link")]
                ),
                _vm._v(" "),
                _c("ul", [
                  _c(
                    ...
                    {
                      staticClass:
                        "pb-2 block flex items-center justify-center lg:justify-end"
                    },
                    [
                      _c(
                        "inertia-link",
        ...
        _c("div", { staticClass: "py-10 text-center" }, [
          ...
          _c("form", { staticClass: "pt-10 sm:pt-12" }, [
            ...
            _c(
              ...
              {
                staticClass:
                  "w-4/6 sm:w-3/4 lg:w-2/5  mx-auto my-2 flex flex-col sm:flex-row justify-center items-center"
              },
              [
                _c(
                  "button",
