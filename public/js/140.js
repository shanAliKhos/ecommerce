...
!(function webpackMissingModule() { var e = new Error("Cannot find module './../../Shared/BackgButton'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    store: function store() {
      var self = this;
      var formData = new FormData(); // formData.append("title", self.form.title || '');
          ...
          _c(
            ...
            [
              _c(
                ...
                [_vm._v("Trending Slider Adjustment")]
              ),
              _vm._v(" "),
              _c(
                "div",
